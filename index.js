...
let help = "how can we help your ministry?\n 1. Add employee \n 2. Add Student. \n 3. Add subject \n 4. show subject \n 5. Display salaries of employees. \n 6. Finding the number of students registered in particular subject \n 7. exit";   
    ...
    switch(parseInt(question)){
        ...
        case 2:
            let StdDataInput = "Input according to this manner \n student-Id,student-Name,student-Level"
            ...
            localStorage.setItem(`student${Math.round(Math.random()*101)}`,studentUser)
            localStorage
            break
        case 3:
